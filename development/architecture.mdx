...
description: >-
  Документ описывает архитектурные решения, рефакторинг и общую структуру
  приложения.
---
## Рефакторинг: WebSocket вместо Polling

### Обзор изменений

Рефакторинг архитектуры приложения с переходом от polling на WebSocket и оптимизацией Service Worker.
...
- [Supabase Setup](../infrastructure/supabase.md) - Настройка Supabase Realtime

- [Notifications Feature](../features/notifications.md) - Система уведомлений

- [Liquid Glass](../development/liquid-glass.md) - UI эффекты
